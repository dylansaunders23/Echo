...
#include <memory>
#include "../../../lab02-pencils-dylansaunders23/src/ui/supportcanvas2d.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SupportCanvas2D_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SupportCanvas2D_t qt_meta_stringdata_SupportCanvas2D = {
    {
QT_MOC_LITERAL(0, 15) // "SupportCanvas2D"
...
const QMetaObject SupportCanvas2D::staticMetaObject = { {
    ...
    qt_meta_stringdata_SupportCanvas2D.offsetsAndSize,
    qt_meta_data_SupportCanvas2D,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SupportCanvas2D_t
, QtPrivate::TypeAndForceComplete<SupportCanvas2D, std::true_type>
